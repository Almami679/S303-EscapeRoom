...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`ObjectDeco` (
  ...
  `ObjectDeco_deleted` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`Game` (
  ...
  `Game_deleted` TINYINT(4) NULL DEFAULT NULL,
  PRIMARY KEY (`Game_id`),
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`Player` (
  ...
  `Player_deleted` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`Sale` (
  ...
  `Sale_deleted` TINYINT(4) NULL DEFAULT NULL,
  PRIMARY KEY (`Sale_id`),

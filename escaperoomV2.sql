...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`EscapeRoom` (
  ...
  `EscapeRoom_deleted` TINYINT NULL,
  `EscapeRoom_createdAt` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`Room` (
  ...
  `Room_escapeRoomId` INT NULL,
  `Room_deleted` TINYINT NULL,
  `Room_createdAt` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`ObjectDeco` (
  ...
  `ObjectDeco_roomId` INT NULL,
  `ObjectDeco_price` DOUBLE NULL,
  `ObjectDeco_deleted` TINYINT NULL,
  `ObjectDeco_createdAt` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`Game` (
  ...
  `Game_escapeRoomId` INT NULL,
  `Game_finished` TINYINT NULL,
  `Game_deleted` TINYINT NULL,
  PRIMARY KEY (`Game_id`),
...
CREATE TABLE IF NOT EXISTS `EscapeRoomDB`.`Sale` (
  ...
  `Sale_gameId` INT NULL,
  `Sale_deleted` TINYINT NULL,
  PRIMARY KEY (`Sale_id`),

...
public class SqlGiftRepository {
    ...
    public void addGift(Gift gift) {
        String sql = "INSERT INTO gift (Gift_id, Gift_gameId, Gift_text, Gift_playerId, Gift_giftKey)" +
                " VALUES (?, ?, ?, ?, ?)";
        try (Connection connection = dbConnection.dbConnect();
            ...
            statement.setString(5, gift.getDiscountKey());
        ...
        try (Connection connection = dbConnection.dbConnect();
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    String giftKey = resultSet.getString("Gift_giftKey");
                    gift = new Gift(id, gameId, text, playerId, giftKey);
                }
            }
            dbConnection.closeConnection(connection);
        } catch (SQLException e) {
